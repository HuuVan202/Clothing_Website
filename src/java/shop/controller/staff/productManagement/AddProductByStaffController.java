...
@WebServlet(name = "AddProductByStaffController", urlPatterns = {"/addProductByStaff"})
@MultipartConfig
public class AddProductByStaffController extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (dao.addProductByStaff(product)) {
