                                        ...
                                        <div class="row gy-3 overflow-hidden">
                                            <div class="col-12">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control border-0 border-bottom rounded-0" name="txtUserName" id="txtUserName" required
                                                           value="${cookie.cUserName.value}">
                                                <label for="txtUserName" class="form-label">Username</label>
                                            </div>
                                        </div>
                                        <span style="color: red; font-size: 14px; font-weight: bold;">${requestScope.msg}</span>
                                        <div class="col-12" style="position: relative;">
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control border-0 border-bottom rounded-0" 
                                                       name="txtPassword" id="txtPassword" required value="${cookie.cPassword.value}">
                                            ...
                                            <div class="row justify-content-between">
                                                <div class="col-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" ${cookie.reMem.value==null?"":"checked"} id="remember" name="remember">
                                                ...
                                                <div class="col-6">
                                                    <div class="text-end">
                                                        <a href="VerifyMail" class="link-secondary text-decoration-none">Forgot password?</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
